...
return new class extends Migration
{
    ...
    {
        Schema::create('grados_profesores', function (Blueprint $table) {
            ...
            $table->string('grado'); // Columna para la materia (puede ser varchar o texto)
    ...
    {
        Schema::dropIfExists('grados_profesores');
    }
};
